...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 24 2017 г., 11:34
...
(1, 4, 'Jeans Garcia ', 'Великолепные джинсы винтажно-голубого цвета. Настоящая находка для любителей качественного денима.\r\n\r\nОсобенности:\r\n\r\n    Зауженные к низу\r\n    Пять карманов\r\n    Высококачественный деним\r\n    Высокая посадка (high fit)\r\n    Выгодно подчеркивают фигуру', 10, NULL, NULL, 'product1.jpg', '0', '0', '0'),
...
(1, 'narek', '$2y$13$48VeXdrjqNCloVIkV9i4fuj9BLPUoZXIjXk6C4bxK9ShYCnydTOQO', 'j4WvGXzKQgUh95ExBTUrr-ZDjxF81eOB');
